...
// Client Testimonials & Video Product Reviews
export const testimonials = [
  {
    ...
    initials: "A",
    projectType: "Reel Edit & Color Grade",
    rating: 5,
    quote: "Broo, video edit adipoli aanu❤️ Loved the pacing & color grade!",
    isReal: true,
  },
  {
    id: "real-2",
    ...
    company: "Verified Client",
    avatar: null, // No-profile DP initial badge
    initials: "K",
    projectType: "Video Editing",
    rating: 5,
    quote: "Editing quality is next level bro, loved the reel pacing & transitions! 🔥",
    isReal: true,
  },
  {
    id: "real-3",
    ...
    initials: "PN",
    projectType: "Brand Commercial Edit",
    rating: 5,
    quote: "Working with Niharika on our festive ad campaign was amazing. The color grading & smooth cuts made it super clean!",
    isReal: true,
  },
  {
    id: "real-4",
    ...
    avatar: null, // No-profile DP initial badge
    initials: "S",
    projectType: "Commercial Brand Edit",
    rating: 5,
    quote: "Color grading & video pacing made my commercial look super premium 💯",
    isReal: true,
  },
  {
    id: "real-5",
    ...
    initials: "AS",
    projectType: "YouTube Edit & Motion",
    rating: 5,
    quote: "Best video editor! Hooked the audience in the first 3 seconds 🔥",
    isReal: true,
  },
  {
    id: "real-6",
    ...
    avatar: null, // No-profile DP initial badge
    initials: "H",
    projectType: "Reel Editing",
    rating: 5,
    quote: "Great quality video editing & super smooth cuts!",
    isReal: true,
  }
];
