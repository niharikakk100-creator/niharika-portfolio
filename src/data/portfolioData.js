...
// Client Testimonials & Project Reviews
export const testimonials = [
  {
    id: "testimonial-akash",
    name: "Akash",
    role: "Brand Shoot",
    company: "Verified Client",
    avatar: "/images/testimonials/akash.jpg",
    initials: "A",
    projectType: "Brand Shoot",
    rating: 5,
    quote: "I had very high expectations from Niharika because I had already seen her previous work. Honestly, she did not disappoint. The final video was even better than what I had imagined. She paid attention to all the small details and the overall output looked very professional.",
    isReal: true,
  },
  {
    id: "testimonial-rohit",
    name: "Rohit",
    role: "Travel Project",
    company: "Verified Client",
    avatar: "/images/testimonials/rohit.jpg",
    initials: "R",
    projectType: "Travel Project",
    rating: 5,
    quote: "When I first saw the raw footage, I honestly didn’t know how this was going to become a proper video 😂 But Niharika completely changed it. The final edit had a very nice flow and everything felt connected. Really happy with how it turned out.",
    isReal: true,
  },
  {
    id: "testimonial-sneha",
    name: "Sneha",
    role: "Wedding Project",
    company: "Verified Client",
    avatar: "/images/testimonials/sneha.jpg",
    initials: "S",
    projectType: "Wedding Project",
    rating: 5,
